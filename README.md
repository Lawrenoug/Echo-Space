...
- 敌人的运行时路径状态已经从双世界位置刷新中隔离：切换世界时不再读取敌人模板根节点坐标，巡逻敌人继续按自身巡逻段运动，原地检测 / 追击敌人只清空攻击判定并在失去目标后回到守点
...
建议先按“可玩闭环优先，UI 外观后置”的顺序推进：

1. 双世界玩法物体：继续补按钮门、世界专属平台、世界差异移动平台，让核心机制不只停留在可破坏墙
2. 关卡节奏复测：实际跑一遍扩展白盒路线，记录跳跃距离、敌人密度、拾取位置和世界切换点是否顺畅
3. 战斗数值复测：重点验证巡逻敌人、追击敌人、灵魂哨卫的弹反窗口、架势打满速度、处决触发和死亡反馈
4. 敌人掉落闭环：让敌人死亡后掉落背包物品或加点资源，把战斗和背包系统进一步串起来
5. UI 正式化：在玩法闭环稳定后，再给背包、加点、设置菜单补正式控件外观，例如槽位网格、属性按钮、滑条、下拉框、键位捕获弹窗
6. 存档评估：等关卡、背包、加点、双世界状态都稳定后，再重新设计存档系统
