...
1. 关卡闭环：把当前白盒扩成一段 3-5 分钟可从左到右游玩的横向关卡，串起跳跃、战斗、拾取、加点和双世界切换
2. 双世界玩法物体：继续补按钮门、世界专属平台、世界差异移动平台，让核心机制不只停留在可破坏墙
3. 战斗验证：用现有巡逻敌人和追击敌人调一版基础数值，重点验证弹反、架势打满、处决、掉落拾取是否顺畅
4. UI 正式化：在玩法闭环稳定后，再给背包、加点、设置菜单补正式控件外观，例如槽位网格、属性按钮、滑条、下拉框、键位捕获弹窗
5. 内容扩展：增加第三种敌人或第一个小 Boss，用来验证敌人战斗基类和双世界机制能不能继续复用
