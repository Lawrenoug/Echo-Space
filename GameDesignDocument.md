...
本文档以完整游戏形态为主。Demo 不是另一套设计，而是从完整设计中截取出的阶段性验证版本，用于优先验证移动手感、双世界机制、战斗闭环、关卡节奏和基础系统复用性。
...
该系统属于完整版本的平衡调优手段，Demo 阶段只需要保留接口可能性，不需要强制实现。
...
只要这三点保持清晰，Demo 与完整版本就会使用同一套设计方向：Demo 验证核心，完整版本扩展规模与表现。
